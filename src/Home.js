...
export default function Home({posts}){
     ...
     return(
      ...
      <div className='social-media'>
        ...
        <div><p style={{color:'#ff0054'}}>Linkedin Profile</p><NavLink className='profile-link btn' to='https://www.linkedin.com/in/jasper-namala-66338224b'><span className='bn54span'>jasper-namala-66338224b</span></NavLink></div>
